...
import 'package:grex_bov/modelo/Vaca.dart';
...
class AjudaVaca {
  ...
  String quantiaNasceu = "quantiaNasceu";
  String dataInse = "dataInse";
  String dataParto = "dataParto";

  String tabelaVacina = "tabela_vacinas";
  String nomeV = "_nomeV";
  String nomeTabela = 'tabela_vacas';
  String nomeTabelaRacas = 'tabela_racas';
  String nomeTabelaInseminacao = 'tabela_inseminacaos';
  String id_inseminacao = 'id';
  String id_vacina = "id";
  String dataInseminacao = "_dataInseminacao";
  String nomeVaca = "nome";
  String nomeVac = "_nomeVac";
  String nomeVacina = "nomeVacina";
  String dataEnxertou = "dataEnxertou";
  ...
  void criaTabelaVacas(Database db, int versao) async {
    ...
    await db.execute('CREATE TABLE $nomeCria ('
        '$id_cria INTEGER PRIMARY KEY AUTOINCREMENT,'
        '$nomeV Text,'
        '$quantiaNasceu Text,'
        '$dataInse Text,'
        '$dataParto Text'
...
//cadastra
  ...
  alterarCria(Cria c, int id) async{
    Database db = await this.database;
    return await db.update(nomeCria, c.toMap(), where: "id = ?", whereArgs: [id]);
  }
  alterarVacina(Vacina v, int id) async{
    Database db = await this.database;
    return await db.update(tabelaVacina, v.toMap(), where: "id = ?", whereArgs: [id]);
  }
  alterarVacinaNome(Vacina v, int nome) async{
    Database db = await this.database;
    return await db.update(tabelaVacina, v.toMap(), where: "id = ?", whereArgs: [nome]);
  }
